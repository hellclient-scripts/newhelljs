(function (app) {
    ...
    objectModule.CNumber.ReUnit = /本|幅|壶|支|顶|块|朵|面|匹|位|支|颗|个|把|只|粒|张|枚|件|柄|根|块|文|两|碗|滴|位|枚|包|片|盒|棵|袋|副/
    objectModule.CNumber.FixedNames = ["一千两银票"]
    App.CNumber = new cnumberModule.CNumber()
    App.CNumber.ReUnit = /本|幅|壶|支|顶|块|朵|面|匹|位|支|颗|个|把|只|粒|张|枚|件|柄|根|块|文|两|碗|滴|位|枚|包|片|盒|棵|袋|副/
