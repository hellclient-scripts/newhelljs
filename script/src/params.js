(function () {
    ...
    App.NamedParams.AddNumber("NumCmds", 44).WithName("每心跳指令数").WithDesc("每个心跳的指令数，游戏设定没修改的话一般不用调整")
    App.NamedParams.AddNumber("SenderTimer", 2300).WithName("发送间隔").WithDesc("发送指令的间隔")
