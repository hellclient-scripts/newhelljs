(function () {
    ...
    App.NamedParams.AddString("LocSleep", "179").WithName("睡觉坐标").WithDesc("睡觉坐标，未指定会根据门派自动判定")
    ...
    App.NamedParams.AddNumber("NeiliMin", 50).WithName("最小内力百分比").WithDesc("判断打坐睡觉的内力百分比比率")
    App.NamedParams.AddNumber("JingliMin", 50).WithName("最小精力百分比").WithDesc("判断打吐纳的精力百分比比率")
